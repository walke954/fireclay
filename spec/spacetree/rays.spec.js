...
describe('SpaceTree', () => {
  ...
  describe('rays', () => {
    it('should overlap aabb', () => {
      ...
      expect(vals.has(rays['0'])).toBe(true);
      expect(vals.has(rays['1'])).toBe(true);
      expect(vals.has(rays['2'])).toBe(true);
      expect(vals.has(rays['3'])).toBe(true);
    });
    ...
    it('should overlap polygon', () => {
      ...
      expect(vals.has(rays['2'])).toBe(true);
      expect(vals.has(rays['3'])).toBe(true);
      expect(vals.has(rays['4'])).toBe(true);
    });
